  ...
  return (
    ...
    >
      ...
      <div className="bg-black bg-opacity-50 p-6 rounded-xl">
        {/* Título principal */}
        <h2 className="text-4xl font-bold mb-6 text-red-400 hover:scale-[1.01] transition-transform duration-300 ease-in-out animate-slideIn">
          Recursos e Apoio
        </h2>

        {/* Texto introdutório */}
        <p className="text-lg md:text-xl leading-relaxed mb-8 animate-fadeIn max-w-4xl text-white">
          <strong>
            Se você ou alguém que conhece está passando por violência doméstica,
            procure ajuda. Existem serviços especializados e canais de denúncia que podem salvar vidas, não fique em silêncio.
          </strong>
        </p>
        ...
        <ul className="space-y-6">
          ...
          <li className="p-6 bg-gray-900 bg-opacity-60 text-white rounded-lg shadow-md transform transition duration-300 hover:scale-[1.01] hover:shadow-lg animate-slideIn">
            <h3 className="font-semibold text-xl text-red-300 mb-3">
              Delegacias da Mulher
            </h3>
          ...
          <li className="p-6 bg-gray-900 bg-opacity-60 text-white rounded-lg shadow-md transform transition duration-300 hover:scale-[1.01] hover:shadow-lg animate-slideIn">
            ...
            <ul className="list-disc pl-6 leading-relaxed mb-2">
        ...
        <div className="mt-10 p-6 bg-gray-900 bg-opacity-60 text-white rounded-lg shadow-md transform transition duration-300 hover:scale-[1.01] hover:shadow-lg animate-fadeIn">
          <h3 className="font-semibold text-xl text-red-300 mb-3">
          ...
          <p className="leading-relaxed mb-4">
            ...
            enquanto a denúncia salva vidas.  
            A legislação brasileira garante proteção e mecanismos de denúncia, mas é essencial que
            todos estejam atentos e engajados.
          </p>

          {/* Referências oficiais */}
          <div className="mt-6 bg-black bg-opacity-40 p-4 rounded-lg">
            <h4 className="font-semibold text-lg text-red-200 mb-2">Referências Oficiais</h4>
            <ul className="list-disc pl-6 text-sm leading-relaxed text-gray-200">
